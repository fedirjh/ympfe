                        ...
                        <form method="POST" action="/bourses/{{ $bourse->id }}">
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control" name="end_date" value="{{ $bourse->end_date }}" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    <label>Place</label>
                                    <input class="form-control" type="text" placeholder="{{ __('bourse place') }}" name="place" value="{{ $bourse->place }}" required>
                                </div>
                            </div>
                      ...
                      <tbody>
                        @foreach($users as $key => $user)
                          <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>{{ $user->app->age }}</td>
                            <td>{{ $user->app->moyenne }}</td>
                            <td>{{ $user->app->graduation }}</td>
                            <td>{{ $user->app->tel }}</td>
                            <td>{{ $user->app->status }}</td>
                            <td>
